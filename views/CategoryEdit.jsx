          ...
          <div className="centered">
            ...
            {category &&
              category.levels.map(level => (
                <div data-js="level-info" data-level={level.levelIndex} className="levels-wrapper">
                  <div data-js="level" className="level-wrapper">
                    <div className="group">
                      <input type="number" required name="level_index" id="id_level_index" value={level.levelIndex} />
                      <span className="highlight" />
                      <span className="bar" />
                    ...
                    <div className="questions-wrapper">
                      {level.questions.map(question => (
                        <div data-js="question" data-qnumber={question.orderIndex} className="question">
